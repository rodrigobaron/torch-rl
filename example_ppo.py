...
from torch_rl.envs import make_default_atari_env
from torch_rl.algo.ppo import Agent
...
def main():
    ...
    envs = gym.vector.SyncVectorEnv(
        [make_default_atari_env(args.env_id, args.seed + i, i, f"{log_path}/videos/{run_name}") for i in range(args.num_envs)]
    )
